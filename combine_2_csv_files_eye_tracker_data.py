...
for i in range(1, 5):  # TODO: : Adjust this later on according to how many subjects, eg.32
...
for idx in tqdm(range(2), desc="In progress Bro...:)"): # TODO: Adjust this according to how many subjects,eg.32
