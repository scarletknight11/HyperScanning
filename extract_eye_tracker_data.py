...
def extract_eye_data(filename, labelsequence):
    try:
        f = open(filename)
    ...
    # else:
        ...
        # %% Load the data
        original_data_path = "/hpc/igum002/codes/frontiers_hyperscanning2/eye_tracker_data_original/"
        ...
        for idx, label in enumerate(chosenOrder):
            label_fname = chosenOrder[idx] + ".csv"
